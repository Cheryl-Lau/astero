...
! ***********************************************************************
      ...
      subroutine astero_data_for_extra_history_columns(id, id_extra, n, astero_names, vals, ierr)
         ...
         call data_for_extra_history_columns(id, id_extra, n, astero_names, vals, ierr)
         if (ierr /= 0) return
         if (s% job% astero_just_call_my_extras_check_model) return
         ...
         i = i+1
         astero_names(i) = 'correction_r'         
         i = i+1
         astero_names(i) = 'a_div_r'
      ...
      subroutine astero_data_for_extra_profile_columns( &
            id, id_extra, n, nz, astero_names, vals, ierr)
         ...
         integer :: k
         ierr = 0
         call data_for_extra_profile_columns(id, id_extra, n, nz, astero_names, vals, ierr)
